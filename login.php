        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8 mb-5">
                    ...
                    <form enctype="multipart/form-data" action="process_login.php" method="post" class="p-5 bg-white">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <input type="email" name="email" id="fullname" class="form-control" placeholder="eg. 123@gmail.com" required>
                            </div>
                        </div>
                        ...
                        <div class="row form-group mb-5">
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <input type="password" name="password" id="fullname" class="form-control" placeholder="eg. !2342@" required>
                            </div>
                        </div>
