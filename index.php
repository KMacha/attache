    ...
    <div class="site-blocks-cover" style="background-image: url(images/hero_bg_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row row-custom align-items-center">
          <div class="col-md-10">
            <h1 class="mb-2 text-black w-75"><span class="font-weight-bold">Largest Attachment</span> Site On The Net</h1>
            <div class="job-search">
              <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active py-3" id="pills-job-tab" data-toggle="pill" href="#pills-job" role="tab" aria-controls="pills-job" aria-selected="true">Find An Attachment</a>
                </li>
<!--                <li class="nav-item">-->
                      ...
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <div class="select-wrap">
                          ...
                          <select name="" id="" class="form-control">
                            ...
                            <option value="fulltime">Accounting/ Finance</option>
                            <option value="fulltime">Automotive Jobs</option>
                            <option value="freelance">Computing</option>
                            <option value="internship">Construction</option>
                            <option value="internship">Telecommunications</option>
                              <option value="internship">Design, Art & Multimedia </option>
                          </select>
                        </div>
                      </div>
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
      ...
      <div class="container">
        <div class="row justify-content-start text-left mb-5">
          <div class="col-md-9" data-aos="fade">
            <h2 class="font-weight-bold text-black">IT Attachments</h2>
          </div>
          <div class="col-md-3" data-aos="fade" data-aos-delay="200">
            <a href="new-post.php" class="btn btn-primary py-3 btn-block"><span class="h5">+</span> Post an Attachment</a>
          </div>
        </div>
        
        <!-- start of that php thingy -->
        
        <?php
			
			function displayinfo($jobname,$id)
			{
				...
				echo '<div class="row" data-aos="fade">';
				 echo '<div class="col-md-12">';
				   ...
				   echo '<div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">';
				     ...
				     echo ' <div class="mb-4 mb-md-0 mr-5">';
				       echo '<div class="job-post-item-header d-flex align-items-center">';
				         echo "<h2 class='mr-3 text-black h4'>$jobname</h2>";
				         echo '<div class="badge-wrap">';
				          echo '<span class="bg-primary text-white badge py-2 px-4">Computing</span>';
				         echo '</div>';
				       echo '</div>';
				       echo '<div class="job-post-item-body d-block d-md-flex">';
				         echo '<div class="mr-3"><span class="fl-bigmug-line-portfolio23"></span> <a href="#">Facebook, Inc.</a></div>';
				         echo '<div><span class="fl-bigmug-line-big104"></span> <span>New York City, USA</span></div>';
				       echo '</div>';
				      echo '</div>';

				      echo '<div class="ml-auto">';
		             // <a href="#" class="btn btn-secondary rounded-circle btn-favorite text-gray-500"><span class="icon-heart"></span></a>
				        echo "<a href='job-single.php?id=$id' class='btn btn-primary py-2'>View Details</a>";
				      echo '</div>';
				   echo '</div>';
		    ...
		    displayinfo("Frontend Development","kelvin");        
        ?>
        
        <!-- end of that php thingy -->
              ...
              <div class="mb-4 mb-md-0 mr-5">
               <div class="job-post-item-header d-flex align-items-center">
                 ...
                 <div class="badge-wrap">
                  <span class="bg-warning text-white badge py-2 px-4">Telecommunication</span>
                 </div>
               </div>
...
<!--                <a href="#" class="btn btn-danger rounded-circle btn-favorite active"><span class="icon-heart"></span></a>-->
                <a href="job-single.php" class="btn btn-primary py-2">View Details</a>
              </div>
