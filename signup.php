...
<!--                            <li><a href="login.php"><span class="rounded bg-primary py-2 px-3 text-white"><span class="h5 mr-2">+</span>Login</span></a></li>-->
    ...
    <div class="unit-5 overlay" style="background-image: url('images/hero_bg_2.jpg');">
        <div class="container text-center">
            ...
            <p class="mb-0 unit-6"><a href="index.php">Home</a> <span class="sep">></span> <span>Sign Up</span></p>
        </div>
    </div>
                    ...
                    <form action="#" class="p-5 bg-white">
                        ...
                        <div class="row form-group mb-5">
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <input type="text" id="fullname" class="form-control" placeholder="eg. John">
                            </div>
                        </div>
                        ...
                        <div class="row form-group mb-5">
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <input type="text" id="fullname" class="form-control" placeholder="eg. Doe">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <input type="email" id="fullname" class="form-control" placeholder="eg. 123@gmail.com">
                            </div>
                        </div>
                        ...
                        <div class="select-wrap mr-auto">
                            ...
                            <label class="font-weight-bold" for="fullname">Field</label>
                        ...
                        <div class="row form-group mb-5">
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <input type="password" id="fullname" class="form-control" placeholder="eg. !2342@">
                            </div>
                        </div>
